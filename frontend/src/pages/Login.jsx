      ...
      >
        ...
        <div className="flex-1 p-6 md:p-13 flex flex-col justify-center bg-white/10">
          ...
          <div className="mb-10">
            ...
            <h2 className="text-4xl font-bold text-slate-800 mt-2 mb-2 tracking-tight">
              Welcome Back
            </h2>

            <p className="text-slate-500 font-medium italic">
              Your personalized career path awaits.
            </p>
          </div>
          ...
          >
            ...
            <motion.button
              ...
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-[#818cf8] to-[#a78bfa] text-white font-bold py-4 rounded-2xl mt-4 transition-all text-lg shadow-lg shadow-indigo-100 disabled:opacity-50"
            >
        ...
        <div
          ...
          style={{
            backgroundImage:
              "linear-gradient(to top, rgba(129, 140, 248, 0.5), rgba(251, 146, 60, 0.1)), url('/assets/bg1.avif')"
          }}
        >
